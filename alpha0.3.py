...
label1 = tk.Label(root,relief='groove',bg='#D3D3DF',width=12,height=2,textvariable=display_text_lower)
label1.grid(row=1,columnspan=3)

display_text_upper  = tk.StringVar()
label2 = tk.Label(root,relief='groove',bg='#9D9DE6',width=12,height=2,textvariable=display_text_upper)
